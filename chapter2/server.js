...
// The method informs the nature of the request and the route is a further subdirectory (basically we direct the request to the body of code to respond appropriately, and these locations or routers are called endpoints)

// Simulating some data for our API endpoints
let data = ['dan']
...
app.get('/api/data', (req, res) => {
  ...
  res.status(223).send(data)
})

app.post('/api/data', (req, res) => {
  console.log('This one was for creating data')
